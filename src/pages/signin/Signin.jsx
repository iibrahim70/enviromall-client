        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input type={showPassword ? 'text' : 'password'} className="w-full border-b border-[#212121] py-2 pl-3 pr-10 focus:outline-none focus:border-b focus:border-[#333333] focus:ring-0" {...register('password', { required: true })} />
          ...
          <input type="submit" className="primary-button w-full" value='Signin' />
        </form>
